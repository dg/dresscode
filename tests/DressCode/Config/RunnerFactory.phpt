...
use DressCode\{Config, ConfigurationException, Extension, NodeRule, Override, Preset, PresetInfo, Profile, RuleContext, RuleInfo, Stage};
...
test('the types of the code come from the PHPStan of the project when the configuration says so', function () {
	...
	$rules = ['no-deprecated-members' => true, 'replaced-members' => ['Acme\Shop\Order::STATUS_PAID' => 'StatusPaid']];
