...
use DressCode\{Analyses, Config, Rules, Style};
...
// every rule that writes a name or an import, together, so that one undoing another shows up as well; group-import
// makes the group uses import-notation expands here, which its own fixtures cover
$rules = [];
foreach ([
	Rules\Namespaces\NameNotationRule::class => ['classes' => 'import', 'functions' => 'import', 'constants' => 'import'],
	Rules\Namespaces\NameFallbackRule::class => ['functions' => 'qualified', 'constants' => 'qualified'],
