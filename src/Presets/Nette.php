...
/**
 * The Nette Coding Standard: PER laid out the Nette way (dresscode/nette-style), the presets of
 * hygiene, and what is left here, the choices the Nette libraries make: how names are cased, in what
