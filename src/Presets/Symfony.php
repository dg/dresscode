 ...
 */
#[PresetInfo('dresscode/symfony', 'Symfony Coding Standards as the @Symfony rule set defines them, without the phpDoc rules')]
final class Symfony implements Preset
{
	public function getProfile(): Profile
	{
		return new Profile(presets: [Per::class, SymfonyConfigurator::class], indent: 4, eol: 'majority', lineLength: false, rules: [
