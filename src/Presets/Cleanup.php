 ...
 * happened. A rule about a doc comment, an import or a member of a class belongs to the preset of that
 * thing instead, so that the six of them stay apart.
 */
#[PresetInfo('dresscode/cleanup', 'Code that is there for nothing')]
