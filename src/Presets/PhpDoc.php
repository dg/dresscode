 ...
 * declaration says better. What a doc comment must contain is a policy of the project, not this preset.
 */
#[PresetInfo('dresscode/phpdoc', 'Doc comments without what the types already say')]
