...
/**
 * How many blank lines stand where: in the header of a file, around declarations, around the braces and members of a class,
	...
	public static function getOptionsSchema(): Schema
	{
		...
		return Expect::structure([
			...
			'afterTraitUses' => BlankLines::schema(1)
				->description('Before the member following the trait uses, unless it is a method: then betweenMethods applies'),
