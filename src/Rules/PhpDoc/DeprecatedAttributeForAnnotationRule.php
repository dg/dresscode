 ...
 *
 * A function, a method, a class constant and an enum case take it. A declaration that carries the attribute
...
final class DeprecatedAttributeForAnnotationRule extends NodeRule
{
	...
	{
		$attributes = $node instanceof FunctionNode || $node instanceof MethodNode || $node instanceof ClassConstNode || $node instanceof EnumCaseNode
			? $node->attributes
			: null;
