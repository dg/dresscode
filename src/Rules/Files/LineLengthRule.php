...
use PhpSyntax\{Indentation, Token, TokenKind, Trivia};
 ...
 * to the next stop of the style wherever on the line it stands, and dresscode/multi-line-condition measures with it
...
#[RuleInfo(
	...
	Stage::Cleanup,
	description: 'Reports lines longer than the line length',
)]
final class LineLengthRule extends NodeRule implements ConfigurableRule
{
	...
	{
		if ($context->getStyle()->lineLength === null) {
			return;
		}
	...
	private function finishLine(array &$line, RuleContext $context): void
	{
		...
		if (
			...
			$message = "The line is $width characters long, the limit is $limit";
			$line['token'] !== null
