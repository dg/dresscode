 ...
 * `#[\Override]`) is left alone. A class constant is the fourth place and the one that asks to be turned on:
 * its type comes from the value it is written as, no annotation saying what a constant is, and PHP 8.3 is
 * where a constant may declare one at all. Each place can be turned off on its own.
 */
#[RuleInfo(
...
final class TypeHintRequiredRule extends NodeRule implements ConfigurableRule
{
	...
	/**
	 * A class constant carries the type of its value, which is where its type can come from, no annotation
	 * saying what a constant is; PHP 8.3 is where a constant may declare one at all.
	 */
