...
/**
 * What replaced-members writes instead of a member, written the way its key is: `StatusPaid` and `$explorer` are
...
final readonly class MemberTarget
{
	...
	/** The replacement as a message names it, for a member of the kind: `Order::StatusPaid`, `Other\Helpers::name()`, `str_contains()`. */
