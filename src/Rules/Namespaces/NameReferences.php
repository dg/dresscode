...
/**
 * What name-notation and name-fallback share: an option given by name or by pattern, and the references of the global
 * names of a namespace with the form each is written in.
 * @internal
 */
