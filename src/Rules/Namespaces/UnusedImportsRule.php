...
use PhpSyntax\{NameKind, Node, SymbolKind, Token, Trivia, TriviaKind};
...
final class UnusedImportsRule extends NodeRule implements ConfigurableRule
{
	...
	public static function getOptionsSchema(): Schema
	{
		return Expect::structure([
			'searchAnnotations' => Expect::bool(true)->description('A class name referenced in a doc comment counts as used, the name of an annotation such as @DB\Entity included'),
		]);
	}
