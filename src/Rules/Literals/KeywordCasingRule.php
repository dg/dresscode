...
final class KeywordCasingRule extends NodeRule
{
	private const Keywords = [
		...
		TokenKind::Implements, TokenKind::List, TokenKind::Array, TokenKind::Callable, TokenKind::NamespaceKeyword,
	];
	...
	public function enter(Node|Token $node, RuleContext $context): void
	{
		...
		$isKeyword = in_array($node->kind, self::Keywords, true) && !$node->parent instanceof IdentifierNode;
		if (!$isKeyword && $node->parent instanceof NameNode) {
			$parts = $node->parent->parts;
