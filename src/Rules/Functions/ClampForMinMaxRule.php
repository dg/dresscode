 ...
 *
 * The fix is risky wherever a bound is not written out: `clamp()` refuses a minimum above its maximum with
 * an error, while the pair of calls answers such bounds with one of them.
 */
#[RuleInfo(
...
final class ClampForMinMaxRule extends NodeRule
{
	...
	public function enter(Node|Token $node, RuleContext $context): void
	{
		...
		// the bound is the one written out as a value; where both or neither are, which is which is unknown
