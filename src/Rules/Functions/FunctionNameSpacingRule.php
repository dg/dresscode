 ...
 * too, and so does the name of a property hook with parameters. What may stand without parentheses (`new Foo`,
 * `exit`, a hook without parameters) is left alone where they are missing: the gap after it is then somebody else's.
 */
#[RuleInfo(
