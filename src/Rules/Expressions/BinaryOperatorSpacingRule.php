 ...
 * array items, and the alignment option says which of it stays: the one made of spaces, the one made of tabs,
 * either, or none. Concatenation has a rule of its own.
 */
#[RuleInfo(
