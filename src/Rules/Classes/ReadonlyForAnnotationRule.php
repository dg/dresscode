 ...
 * and extend nothing, use no trait, whose properties are elsewhere, allow no dynamic properties, and every property
 * of it must be one the keyword could stand on.
 *
