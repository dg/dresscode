...
final class UselessModifierRule extends NodeRule
{
	...
	/**
	 * Whether the method is private and final, which PHP 8.0 warns about, no class ever overriding a private
	 * method. The constructor is the exception PHP itself makes: final on it still forbids a child a constructor.
	 */
