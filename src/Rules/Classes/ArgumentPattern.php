 ...
 * `$name, $label, true`, `fallback: $f, ...`, `$callable, ...$args`. A placeholder stands for any expression,
...
final readonly class ArgumentPattern
{
	 ...
	 * argument passed by the name of its parameter too, which takes the parameters of the method; without them such
	 * a call is of no shape. A call that leaves arguments open with `?` or `...` is none either.
