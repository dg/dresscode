...
final readonly class MemberPattern
{
	 ...
	 * being another class to create. A method that is not static is not called with `::`, unless every class has it
	 * and not static, `parent::name()`, and a property the class does not declare is not the one a child declares
	...
	/**
	 * Whether a method declared in the class overrides this member: the name agrees and the class is a subtype of
	 * the class of the member, which itself declares the member and overrides nothing.
	 */
	...
	/** The member as a message names it, of the kind the code reaches it by: `Constant Nette\Forms\Form::FILLED`. */
