 ...
 * Two foreign rules covered by one DressCode rule are merged: a list option becomes the union, a map merges key
 * by key, a boolean is true when either of them says true, anything else is the value written last.
 * @internal
 */
