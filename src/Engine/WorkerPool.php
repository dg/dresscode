...
final class WorkerPool
{
	...
	/**
	 * A connection is read without blocking: a worker may have sent only a part of its line, and waiting for the
	 * rest would stop the parent from hearing the others and from noticing a worker that is stuck.
