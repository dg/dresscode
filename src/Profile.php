...
/**
 * What decides how a file is processed: the presets and the rules, the style, the version of PHP the code is written
 * for, what its namespaces declare, and the rules whose risky fixes are accepted or whose violations only warn. A preset
...
readonly class Profile
{
	...
	public function __construct(
		...
		/** the version the rules target, as major.minor; without one it is the version of composer.json */
