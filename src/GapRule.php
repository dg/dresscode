 ...
 * whose claim it is. Two plain claims on the same component of the same side of the same slot are a
 * configuration error, so that a gap has one owner, and so is a claim on a slot no node has; closures may share
 * a slot, each abstaining where the other decides. The rule visits nothing itself.
 */
