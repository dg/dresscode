...
final class NeonReader
{
	...
	/**
	 * The keys of a profile as its constructor takes them: the entity of a rule is the recipe of its factory, and a version
	 * written as a number is the version it stands for.
	 * @param  array<string, mixed>  $data
	 ...
	 * build; the class or method it starts from is looked up now, so that a misspelled one is an error of the file.
	 * @return \Closure(): Rule
	 * @throws \InvalidArgumentException
	 */
