...
final readonly class ResolvedConfig
{
	 ...
	 * the options they end up with, whether a closure builds them and whether their risky fixes are made, the
	 * style, the target version and what the namespaces declare. A changed default is a changed value here, which a description of what the
	 * configuration said would miss.
