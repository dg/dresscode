...
/**
 * The parameters of the functions of PHP 8.0 to 8.5 and of the extensions shipped with it.
 * @internal generated part of PhpSignatures
 */
trait PhpSignaturesData
{
	...
	private const Signatures = [
		...
		'array_diff_uassoc' => 'array array,mixed ...rest=',
		'array_diff_ukey' => 'array array,mixed ...rest=',
		'array_fill' => 'int start_index,int count,mixed value',
		'array_fill_keys' => 'array keys,mixed value',
		'array_filter' => 'array array,callable|null callback=,int mode=',
		...
		'array_intersect_uassoc' => 'array array,mixed ...rest=',
		'array_intersect_ukey' => 'array array,mixed ...rest=',
		...
		'array_multisort' => 'mixed &array,mixed ...&rest=',
		...
		'array_slice' => 'array array,int offset,int|null length=,bool preserve_keys=',
		'array_splice' => 'array &array,int offset,int|null length=,mixed replacement=',
		'array_sum' => 'array array',
		'array_udiff' => 'array array,mixed ...rest=',
		'array_udiff_assoc' => 'array array,mixed ...rest=',
		'array_udiff_uassoc' => 'array array,mixed ...rest=',
		'array_uintersect' => 'array array,mixed ...rest=',
		'array_uintersect_assoc' => 'array array,mixed ...rest=',
		'array_uintersect_uassoc' => 'array array,mixed ...rest=',
		...
		'bcadd' => 'string num1,string num2,int|null scale=',
		'bcceil' => 'string num',
		'bccomp' => 'string num1,string num2,int|null scale=',
		'bcdiv' => 'string num1,string num2,int|null scale=',
		'bcdivmod' => 'string num1,string num2,int|null scale=',
		'bcfloor' => 'string num',
		'bcmod' => 'string num1,string num2,int|null scale=',
		'bcmul' => 'string num1,string num2,int|null scale=',
		'bcpow' => 'string num,string exponent,int|null scale=',
		'bcpowmod' => 'string num,string exponent,string modulus,int|null scale=',
		'bcround' => 'string num,int precision=,RoundingMode mode=',
		'bcscale' => 'int|null scale=',
		'bcsqrt' => 'string num,int|null scale=',
		'bcsub' => 'string num1,string num2,int|null scale=',
		'bin2hex' => 'string string',
		'bind_textdomain_codeset' => 'string domain,string|null codeset=',
		'bindec' => 'string binary_string',
		'bindtextdomain' => 'string domain,string|null directory=',
		'boolval' => 'mixed value',
		'bzclose' => 'mixed bz',
		...
		'bzread' => 'mixed bz,int length=',
		'bzwrite' => 'mixed bz,string data,int|null length=',
		...
		'class_implements' => 'mixed object_or_class,bool autoload=',
		'class_parents' => 'mixed object_or_class,bool autoload=',
		'class_uses' => 'mixed object_or_class,bool autoload=',
		'clearstatcache' => 'bool clear_realpath_cache=,string filename=',
		'cli_get_process_title' => '',
		'cli_set_process_title' => 'string title',
		'closedir' => 'mixed dir_handle=',
		'closelog' => '',
		...
		'copy' => 'string from,string to,mixed context=',
		'cos' => 'float num',
		'cosh' => 'float num',
		...
		'curl_file_create' => 'string filename,string|null mime_type=,string|null posted_filename=',
		'curl_getinfo' => 'CurlHandle handle,int|null option=',
		...
		'curl_multi_exec' => 'CurlMultiHandle multi_handle,mixed &still_running',
		'curl_multi_get_handles' => 'CurlMultiHandle multi_handle',
		'curl_multi_getcontent' => 'CurlHandle handle',
		'curl_multi_info_read' => 'CurlMultiHandle multi_handle,mixed &queued_messages=',
		'curl_multi_init' => '',
		...
		'curl_share_init' => '',
		'curl_share_init_persistent' => 'array share_options',
		...
		'date_create' => 'string datetime=,DateTimeZone|null timezone=',
		'date_create_from_format' => 'string format,string datetime,DateTimeZone|null timezone=',
		'date_create_immutable' => 'string datetime=,DateTimeZone|null timezone=',
		...
		'date_sunrise' => 'int timestamp,int returnFormat=,float|null latitude=,float|null longitude=,float|null zenith=,float|null utcOffset=',
		'date_sunset' => 'int timestamp,int returnFormat=,float|null latitude=,float|null longitude=,float|null zenith=,float|null utcOffset=',
		...
		'datefmt_create' => 'string|null locale,int dateType=,int timeType=,IntlTimeZone|DateTimeZone|string|null timezone=,IntlCalendar|int|null calendar=,string|null pattern=',
		'datefmt_format' => 'IntlDateFormatter formatter,mixed datetime',
		'datefmt_format_object' => 'mixed datetime,mixed format=,string|null locale=',
		...
		'datefmt_localtime' => 'IntlDateFormatter formatter,string string,mixed &offset=',
		'datefmt_parse' => 'IntlDateFormatter formatter,string string,mixed &offset=',
		...
		'dba_delete' => 'array|string key,Dba\\Connection dba',
		'dba_exists' => 'array|string key,Dba\\Connection dba',
		'dba_fetch' => 'array|string key,mixed dba,mixed skip=',
		'dba_firstkey' => 'Dba\\Connection dba',
		'dba_handlers' => 'bool full_info=',
		'dba_insert' => 'array|string key,string value,Dba\\Connection dba',
		'dba_key_split' => 'string|false|null key',
		'dba_list' => '',
		'dba_nextkey' => 'Dba\\Connection dba',
		'dba_open' => 'string path,string mode,string|null handler=,int permission=,int map_size=,int|null flags=',
		'dba_optimize' => 'Dba\\Connection dba',
		'dba_popen' => 'string path,string mode,string|null handler=,int permission=,int map_size=,int|null flags=',
		'dba_replace' => 'array|string key,string value,Dba\\Connection dba',
		...
		'deflate_init' => 'int encoding,object|array options=',
		'deg2rad' => 'float num',
		'dgettext' => 'string domain,string message',
		'dir' => 'string directory,mixed context=',
		...
		'dns_get_mx' => 'string hostname,mixed &hosts,mixed &weights=',
		'dns_get_record' => 'string hostname,int type=,mixed &authoritative_name_servers=,mixed &additional_records=,bool raw=',
		'dom\\import_simplexml' => 'object node',
		'dom_import_simplexml' => 'object node',
		'doubleval' => 'mixed value',
		'easter_date' => 'int|null year=,int mode=',
		'easter_days' => 'int|null year=,int mode=',
		...
		'enchant_dict_quick_check' => 'EnchantDictionary dictionary,string word,mixed &suggestions=',
		'enchant_dict_remove' => 'EnchantDictionary dictionary,string word',
		'enchant_dict_remove_from_session' => 'EnchantDictionary dictionary,string word',
		...
		'error_clear_last' => '',
		'error_get_last' => '',
		'error_log' => 'string message,int message_type=,string|null destination=,string|null additional_headers=',
		'error_reporting' => 'int|null error_level=',
		'escapeshellarg' => 'string arg',
		'escapeshellcmd' => 'string command',
		'exec' => 'string command,mixed &output=,mixed &result_code=',
		'exif_imagetype' => 'string filename',
		'exif_read_data' => 'mixed file,string|null required_sections=,bool as_arrays=,bool read_thumbnail=',
		'exif_tagname' => 'int index',
		'exif_thumbnail' => 'mixed file,mixed &width=,mixed &height=,mixed &image_type=',
		'exp' => 'float num',
		...
		'fclose' => 'mixed stream',
		'fdatasync' => 'mixed stream',
		'fdiv' => 'float num1,float num2',
		'feof' => 'mixed stream',
		'fflush' => 'mixed stream',
		'fgetc' => 'mixed stream',
		'fgetcsv' => 'mixed stream,int|null length=,string separator=,string enclosure=,string escape=',
		'fgets' => 'mixed stream,int|null length=',
		'file' => 'string filename,int flags=,mixed context=',
		'file_exists' => 'string filename',
		'file_get_contents' => 'string filename,bool use_include_path=,mixed context=,int offset=,int|null length=',
		'file_put_contents' => 'string filename,mixed data,int flags=,mixed context=',
		...
		'finfo_buffer' => 'finfo finfo,string string,int flags=,mixed context=',
		'finfo_close' => 'finfo finfo',
		'finfo_file' => 'finfo finfo,string filename,int flags=,mixed context=',
		'finfo_open' => 'int flags=,string|null magic_database=',
		'finfo_set_flags' => 'finfo finfo,int flags',
		'floatval' => 'mixed value',
		'flock' => 'mixed stream,int operation,mixed &would_block=',
		'floor' => 'int|float num',
		'flush' => '',
		'fmod' => 'float num1,float num2',
		'fnmatch' => 'string pattern,string filename,int flags=',
		'fopen' => 'string filename,string mode,bool use_include_path=,mixed context=',
		'forward_static_call' => 'callable callback,mixed ...args=',
		'forward_static_call_array' => 'callable callback,array args',
		'fpassthru' => 'mixed stream',
		'fpow' => 'float num,float exponent',
		'fprintf' => 'mixed stream,string format,mixed ...values=',
		'fputcsv' => 'mixed stream,array fields,string separator=,string enclosure=,string escape=,string eol=',
		'fputs' => 'mixed stream,string data,int|null length=',
		'fread' => 'mixed stream,int length',
		'frenchtojd' => 'int month,int day,int year',
		'fscanf' => 'mixed stream,string format,mixed ...&vars=',
		'fseek' => 'mixed stream,int offset,int whence=',
		'fsockopen' => 'string hostname,int port=,mixed &error_code=,mixed &error_message=,float|null timeout=',
		'fstat' => 'mixed stream',
		'fsync' => 'mixed stream',
		'ftell' => 'mixed stream',
		'ftok' => 'string filename,string project_id',
		'ftp_alloc' => 'FTP\\Connection ftp,int size,mixed &response=',
		'ftp_append' => 'FTP\\Connection ftp,string remote_filename,string local_filename,int mode=',
		...
		'ftp_connect' => 'string hostname,int port=,int timeout=',
		'ftp_delete' => 'FTP\\Connection ftp,string filename',
		'ftp_exec' => 'FTP\\Connection ftp,string command',
		'ftp_fget' => 'FTP\\Connection ftp,mixed stream,string remote_filename,int mode=,int offset=',
		'ftp_fput' => 'FTP\\Connection ftp,string remote_filename,mixed stream,int mode=,int offset=',
		'ftp_get' => 'FTP\\Connection ftp,string local_filename,string remote_filename,int mode=,int offset=',
		'ftp_get_option' => 'FTP\\Connection ftp,int option',
		'ftp_login' => 'FTP\\Connection ftp,string username,string password',
		...
		'ftp_nb_fget' => 'FTP\\Connection ftp,mixed stream,string remote_filename,int mode=,int offset=',
		'ftp_nb_fput' => 'FTP\\Connection ftp,string remote_filename,mixed stream,int mode=,int offset=',
		...
		'ftp_put' => 'FTP\\Connection ftp,string remote_filename,string local_filename,int mode=,int offset=',
		...
		'ftp_set_option' => 'FTP\\Connection ftp,int option,mixed value',
		...
		'ftruncate' => 'mixed stream,int size',
		'func_get_arg' => 'int position',
		'func_get_args' => '',
		'func_num_args' => '',
		'function_exists' => 'string function',
		'fwrite' => 'mixed stream,string data,int|null length=',
		'gc_collect_cycles' => '',
		'gc_disable' => '',
		'gc_enable' => '',
		'gc_enabled' => '',
		...
		'gc_status' => '',
		'gd_info' => '',
		'get_browser' => 'string|null user_agent=,bool return_array=',
		'get_called_class' => '',
		...
		'get_headers' => 'string url,bool associative=,mixed context=',
		...
		'get_required_files' => '',
		'get_resource_id' => 'mixed resource',
		'get_resource_type' => 'mixed resource',
		'get_resources' => 'string|null type=',
		'getcwd' => '',
		'getdate' => 'int|null timestamp=',
		'getenv' => 'string|null name=,bool local_only=',
		'gethostbyaddr' => 'string ip',
		'gethostbyname' => 'string hostname',
		'gethostbynamel' => 'string hostname',
		'gethostname' => '',
		'getimagesize' => 'string filename,mixed &image_info=',
		'getimagesizefromstring' => 'string string,mixed &image_info=',
		'getlastmod' => '',
		'getmxrr' => 'string hostname,mixed &hosts,mixed &weights=',
		'getmygid' => '',
		'getmyinode' => '',
		'getmypid' => '',
		'getmyuid' => '',
		'getopt' => 'string short_options,array long_options=,mixed &rest_index=',
		...
		'gmmktime' => 'int hour,int|null minute=,int|null second=,int|null month=,int|null day=,int|null year=',
		...
		'gmp_div' => 'GMP|string|int num1,GMP|string|int num2,int rounding_mode=',
		'gmp_div_q' => 'GMP|string|int num1,GMP|string|int num2,int rounding_mode=',
		'gmp_div_qr' => 'GMP|string|int num1,GMP|string|int num2,int rounding_mode=',
		'gmp_div_r' => 'GMP|string|int num1,GMP|string|int num2,int rounding_mode=',
		'gmp_divexact' => 'GMP|string|int num1,GMP|string|int num2',
		'gmp_export' => 'GMP|string|int num,int word_size=,int flags=',
		...
		'gmp_import' => 'string data,int word_size=,int flags=',
		'gmp_init' => 'string|int num,int base=',
		...
		'gmp_prob_prime' => 'GMP|string|int num,int repetitions=',
		...
		'grapheme_extract' => 'string haystack,int size,int type=,int offset=,mixed &next=',
		'grapheme_levenshtein' => 'string string1,string string2,int insertion_cost=,int replacement_cost=,int deletion_cost=,string locale=',
		'grapheme_str_split' => 'string string,int length=',
		'grapheme_stripos' => 'string haystack,string needle,int offset=,string locale=',
		'grapheme_stristr' => 'string haystack,string needle,bool beforeNeedle=,string locale=',
		'grapheme_strlen' => 'string string',
		'grapheme_strpos' => 'string haystack,string needle,int offset=,string locale=',
		'grapheme_strripos' => 'string haystack,string needle,int offset=,string locale=',
		'grapheme_strrpos' => 'string haystack,string needle,int offset=,string locale=',
		'grapheme_strstr' => 'string haystack,string needle,bool beforeNeedle=,string locale=',
		'grapheme_substr' => 'string string,int offset,int|null length=,string locale=',
		'gregoriantojd' => 'int month,int day,int year',
		'gzclose' => 'mixed stream',
		...
		'gzgetc' => 'mixed stream',
		'gzgets' => 'mixed stream,int|null length=',
		'gzinflate' => 'string data,int max_length=',
		'gzopen' => 'string filename,string mode,bool use_include_path=',
		'gzpassthru' => 'mixed stream',
		'gzputs' => 'mixed stream,string data,int|null length=',
		'gzread' => 'mixed stream,int length',
		'gzrewind' => 'mixed stream',
		'gzseek' => 'mixed stream,int offset,int whence=',
		'gztell' => 'mixed stream',
		'gzuncompress' => 'string data,int max_length=',
		'gzwrite' => 'mixed stream,string data,int|null length=',
		...
		'hash_update_file' => 'HashContext context,string filename,mixed stream_context=',
		'hash_update_stream' => 'HashContext context,mixed stream,int length=',
		'header' => 'string header,bool replace=,int response_code=',
		'header_register_callback' => 'callable callback',
		'header_remove' => 'string|null name=',
		'headers_list' => '',
		'headers_sent' => 'mixed &filename=,mixed &line=',
		...
		'html_entity_decode' => 'string string,int flags=,string|null encoding=',
		'htmlentities' => 'string string,int flags=,string|null encoding=,bool double_encode=',
		'htmlspecialchars' => 'string string,int flags=,string|null encoding=,bool double_encode=',
		'htmlspecialchars_decode' => 'string string,int flags=',
		'http_build_query' => 'object|array data,string numeric_prefix=,string|null arg_separator=,int encoding_type=',
		...
		'iconv_mime_decode' => 'string string,int mode=,string|null encoding=',
		'iconv_mime_decode_headers' => 'string headers,int mode=,string|null encoding=',
		'iconv_mime_encode' => 'string field_name,string field_value,array options=',
		'iconv_set_encoding' => 'string type,string encoding',
		'iconv_strlen' => 'string string,string|null encoding=',
		'iconv_strpos' => 'string haystack,string needle,int offset=,string|null encoding=',
		'iconv_strrpos' => 'string haystack,string needle,string|null encoding=',
		'iconv_substr' => 'string string,int offset,int|null length=,string|null encoding=',
		'idate' => 'string format,int|null timestamp=',
		'idn_to_ascii' => 'string domain,int flags=,int variant=,mixed &idna_info=',
		'idn_to_utf8' => 'string domain,int flags=,int variant=,mixed &idna_info=',
		...
		'imageaffine' => 'GdImage image,array affine,array|null clip=',
		...
		'imagebmp' => 'GdImage image,mixed file=,bool compressed=',
		...
		'imagecolortransparent' => 'GdImage image,int|null color=',
		...
		'imagefilledpolygon' => 'GdImage image,array points,int num_points_or_color,int|null color=',
		...
		'imagefilter' => 'GdImage image,int filter,mixed ...args=',
		...
		'imagegd' => 'GdImage image,string|null file=',
		'imagegd2' => 'GdImage image,string|null file=,int chunk_size=,int mode=',
		'imagegetclip' => 'GdImage image',
		'imagegetinterpolation' => 'GdImage image',
		'imagegif' => 'GdImage image,mixed file=',
		'imageinterlace' => 'GdImage image,bool|null enable=',
		'imageistruecolor' => 'GdImage image',
		'imagejpeg' => 'GdImage image,mixed file=,int quality=',
		...
		'imageopenpolygon' => 'GdImage image,array points,int num_points_or_color,int|null color=',
		'imagepalettecopy' => 'GdImage dst,GdImage src',
		'imagepalettetotruecolor' => 'GdImage image',
		'imagepng' => 'GdImage image,mixed file=,int quality=,int filters=',
		'imagepolygon' => 'GdImage image,array points,int num_points_or_color,int|null color=',
		'imagerectangle' => 'GdImage image,int x1,int y1,int x2,int y2,int color',
		'imageresolution' => 'GdImage image,int|null resolution_x=,int|null resolution_y=',
		...
		'imagetypes' => '',
		'imagewbmp' => 'GdImage image,mixed file=,int|null foreground_color=',
		'imagewebp' => 'GdImage image,mixed file=,int quality=',
		'imagexbm' => 'GdImage image,string|null filename,int|null foreground_color=',
		'imap_8bit' => 'string string',
		'imap_alerts' => '',
		'imap_append' => 'IMAP\\Connection imap,string folder,string message,string|null options=,string|null internal_date=',
		...
		'imap_check' => 'IMAP\\Connection imap',
		'imap_clearflag_full' => 'IMAP\\Connection imap,string sequence,string flag,int options=',
		'imap_close' => 'IMAP\\Connection imap,int flags=',
		'imap_create' => 'IMAP\\Connection imap,string mailbox',
		'imap_createmailbox' => 'IMAP\\Connection imap,string mailbox',
		'imap_delete' => 'IMAP\\Connection imap,string message_nums,int flags=',
		'imap_deletemailbox' => 'IMAP\\Connection imap,string mailbox',
		'imap_errors' => '',
		'imap_expunge' => 'IMAP\\Connection imap',
		'imap_fetch_overview' => 'IMAP\\Connection imap,string sequence,int flags=',
		'imap_fetchbody' => 'IMAP\\Connection imap,int message_num,string section,int flags=',
		'imap_fetchheader' => 'IMAP\\Connection imap,int message_num,int flags=',
		'imap_fetchmime' => 'IMAP\\Connection imap,int message_num,string section,int flags=',
		'imap_fetchstructure' => 'IMAP\\Connection imap,int message_num,int flags=',
		'imap_fetchtext' => 'IMAP\\Connection imap,int message_num,int flags=',
		'imap_gc' => 'IMAP\\Connection imap,int flags',
		'imap_get_quota' => 'IMAP\\Connection imap,string quota_root',
		'imap_get_quotaroot' => 'IMAP\\Connection imap,string mailbox',
		...
		'imap_headers' => 'IMAP\\Connection imap',
		'imap_is_open' => 'IMAP\\Connection imap',
		'imap_last_error' => '',
		'imap_list' => 'IMAP\\Connection imap,string reference,string pattern',
		'imap_listmailbox' => 'IMAP\\Connection imap,string reference,string pattern',
		'imap_listscan' => 'IMAP\\Connection imap,string reference,string pattern,string content',
		'imap_listsubscribed' => 'IMAP\\Connection imap,string reference,string pattern',
		'imap_lsub' => 'IMAP\\Connection imap,string reference,string pattern',
		'imap_mail' => 'string to,string subject,string message,string|null additional_headers=,string|null cc=,string|null bcc=,string|null return_path=',
		'imap_mail_compose' => 'array envelope,array bodies',
		'imap_mail_copy' => 'IMAP\\Connection imap,string message_nums,string mailbox,int flags=',
		'imap_mail_move' => 'IMAP\\Connection imap,string message_nums,string mailbox,int flags=',
		'imap_mailboxmsginfo' => 'IMAP\\Connection imap',
		'imap_mime_header_decode' => 'string string',
		'imap_msgno' => 'IMAP\\Connection imap,int message_uid',
		'imap_mutf7_to_utf8' => 'string string',
		'imap_num_msg' => 'IMAP\\Connection imap',
		'imap_num_recent' => 'IMAP\\Connection imap',
		'imap_open' => 'string mailbox,string user,string password,int flags=,int retries=,array options=',
		'imap_ping' => 'IMAP\\Connection imap',
		'imap_qprint' => 'string string',
		'imap_rename' => 'IMAP\\Connection imap,string from,string to',
		'imap_renamemailbox' => 'IMAP\\Connection imap,string from,string to',
		'imap_reopen' => 'IMAP\\Connection imap,string mailbox,int flags=,int retries=',
		'imap_rfc822_parse_adrlist' => 'string string,string default_hostname',
		'imap_rfc822_parse_headers' => 'string headers,string default_hostname=',
		'imap_rfc822_write_address' => 'string mailbox,string hostname,string personal',
		'imap_savebody' => 'IMAP\\Connection imap,mixed file,int message_num,string section=,int flags=',
		'imap_scan' => 'IMAP\\Connection imap,string reference,string pattern,string content',
		'imap_scanmailbox' => 'IMAP\\Connection imap,string reference,string pattern,string content',
		'imap_search' => 'IMAP\\Connection imap,string criteria,int flags=,string charset=',
		'imap_set_quota' => 'IMAP\\Connection imap,string quota_root,int mailbox_size',
		'imap_setacl' => 'IMAP\\Connection imap,string mailbox,string user_id,string rights',
		'imap_setflag_full' => 'IMAP\\Connection imap,string sequence,string flag,int options=',
		'imap_sort' => 'IMAP\\Connection imap,int criteria,bool reverse,int flags=,string|null search_criteria=,string|null charset=',
		'imap_status' => 'IMAP\\Connection imap,string mailbox,int flags',
		'imap_subscribe' => 'IMAP\\Connection imap,string mailbox',
		'imap_thread' => 'IMAP\\Connection imap,int flags=',
		'imap_timeout' => 'int timeout_type,int timeout=',
		'imap_uid' => 'IMAP\\Connection imap,int message_num',
		'imap_undelete' => 'IMAP\\Connection imap,string message_nums,int flags=',
		'imap_unsubscribe' => 'IMAP\\Connection imap,string mailbox',
		...
		'inflate_init' => 'int encoding,object|array options=',
		'ini_alter' => 'string option,string|int|float|bool|null value',
		'ini_get' => 'string option',
		'ini_get_all' => 'string|null extension=,bool details=',
		...
		'intlcal_clear' => 'IntlCalendar calendar,int|null field=',
		'intlcal_create_instance' => 'IntlTimeZone|DateTimeZone|string|null timezone=,string|null locale=',
		...
		'intlcal_from_date_time' => 'DateTime|string datetime,string|null locale=',
		...
		'intlcal_is_weekend' => 'IntlCalendar calendar,float|null timestamp=',
		'intlcal_roll' => 'IntlCalendar calendar,int field,mixed value',
		...
		'intlgregcal_create_instance' => 'mixed timezoneOrYear=,mixed localeOrMonth=,mixed day=,mixed hour=,mixed minute=,mixed second=',
		...
		'intltz_create_enumeration' => 'string|int|null countryOrRawOffset=',
		'intltz_create_time_zone' => 'string timezoneId',
		'intltz_create_time_zone_id_enumeration' => 'int type,string|null region=,int|null rawOffset=',
		'intltz_from_date_time_zone' => 'DateTimeZone timezone',
		'intltz_get_canonical_id' => 'string timezoneId,mixed &isSystemId=',
		'intltz_get_display_name' => 'IntlTimeZone timezone,bool dst=,int style=,string|null locale=',
		...
		'intltz_get_id_for_windows_id' => 'string timezoneId,string|null region=',
		'intltz_get_offset' => 'IntlTimeZone timezone,float timestamp,bool local,mixed &rawOffset,mixed &dstOffset',
		...
		'is_bool' => 'mixed value',
		'is_callable' => 'mixed value,bool syntax_only=,mixed &callable_name=',
		...
		'json_decode' => 'string json,bool|null associative=,int depth=,int flags=',
		...
		'ldap_add' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_add_ext' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_bind' => 'LDAP\\Connection ldap,string|null dn=,string|null password=',
		'ldap_bind_ext' => 'LDAP\\Connection ldap,string|null dn=,string|null password=,array|null controls=',
		'ldap_close' => 'LDAP\\Connection ldap',
		'ldap_compare' => 'LDAP\\Connection ldap,string dn,string attribute,string value,array|null controls=',
		'ldap_connect' => 'string|null uri=,int port=',
		'ldap_count_entries' => 'LDAP\\Connection ldap,LDAP\\Result result',
		'ldap_count_references' => 'LDAP\\Connection ldap,LDAP\\Result result',
		'ldap_delete' => 'LDAP\\Connection ldap,string dn,array|null controls=',
		'ldap_delete_ext' => 'LDAP\\Connection ldap,string dn,array|null controls=',
		...
		'ldap_exop' => 'LDAP\\Connection ldap,string request_oid,string|null request_data=,array|null controls=,mixed &response_data=,mixed &response_oid=',
		'ldap_exop_passwd' => 'LDAP\\Connection ldap,string user=,string old_password=,string new_password=,mixed &controls=',
		'ldap_exop_refresh' => 'LDAP\\Connection ldap,string dn,int ttl',
		'ldap_exop_sync' => 'LDAP\\Connection ldap,string request_oid,string|null request_data=,array|null controls=,mixed &response_data=,mixed &response_oid=',
		...
		'ldap_get_option' => 'LDAP\\Connection|null ldap,int option,mixed &value=',
		...
		'ldap_list' => 'mixed ldap,array|string base,array|string filter,array attributes=,int attributes_only=,int sizelimit=,int timelimit=,int deref=,array|null controls=',
		'ldap_mod_add' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_mod_add_ext' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_mod_del' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_mod_del_ext' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_mod_replace' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_mod_replace_ext' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_modify' => 'LDAP\\Connection ldap,string dn,array entry,array|null controls=',
		'ldap_modify_batch' => 'LDAP\\Connection ldap,string dn,array modifications_info,array|null controls=',
		...
		'ldap_parse_exop' => 'LDAP\\Connection ldap,LDAP\\Result result,mixed &response_data=,mixed &response_oid=',
		'ldap_parse_reference' => 'LDAP\\Connection ldap,LDAP\\ResultEntry entry,mixed &referrals',
		'ldap_parse_result' => 'LDAP\\Connection ldap,LDAP\\Result result,mixed &error_code,mixed &matched_dn=,mixed &error_message=,mixed &referrals=,mixed &controls=',
		'ldap_read' => 'mixed ldap,array|string base,array|string filter,array attributes=,int attributes_only=,int sizelimit=,int timelimit=,int deref=,array|null controls=',
		'ldap_rename' => 'LDAP\\Connection ldap,string dn,string new_rdn,string new_parent,bool delete_old_rdn,array|null controls=',
		'ldap_rename_ext' => 'LDAP\\Connection ldap,string dn,string new_rdn,string new_parent,bool delete_old_rdn,array|null controls=',
		'ldap_search' => 'mixed ldap,array|string base,array|string filter,array attributes=,int attributes_only=,int sizelimit=,int timelimit=,int deref=,array|null controls=',
		'ldap_set_option' => 'LDAP\\Connection|null ldap,int option,mixed value',
		'ldap_set_rebind_proc' => 'LDAP\\Connection ldap,callable|null callback',
		...
		'libxml_set_streams_context' => 'mixed context',
		'libxml_use_internal_errors' => 'bool|null use_errors=',
		'link' => 'string target,string link',
		'linkinfo' => 'string path',
		'locale_accept_from_http' => 'string header',
		'locale_add_likely_subtags' => 'string locale',
		...
		'locale_get_default' => '',
		'locale_get_display_language' => 'string locale,string|null displayLocale=',
		'locale_get_display_name' => 'string locale,string|null displayLocale=',
		'locale_get_display_region' => 'string locale,string|null displayLocale=',
		'locale_get_display_script' => 'string locale,string|null displayLocale=',
		'locale_get_display_variant' => 'string locale,string|null displayLocale=',
		...
		'locale_is_right_to_left' => 'string locale',
		'locale_lookup' => 'array languageTag,string locale,bool canonicalize=,string|null defaultLocale=',
		'locale_minimize_subtags' => 'string locale',
		'locale_parse' => 'string locale',
		'locale_set_default' => 'string locale',
		'localeconv' => '',
		'localtime' => 'int|null timestamp=,bool associative=',
		...
		'mb_check_encoding' => 'array|string|null value=,string|null encoding=',
		...
		'mb_convert_kana' => 'string string,string mode=,string|null encoding=',
		...
		'mb_decode_numericentity' => 'string string,array map,string|null encoding=',
		'mb_detect_encoding' => 'string string,array|string|null encodings=,bool strict=',
		'mb_detect_order' => 'array|string|null encoding=',
		'mb_encode_mimeheader' => 'string string,string|null charset=,string|null transfer_encoding=,string newline=,int indent=',
		'mb_encode_numericentity' => 'string string,array map,string|null encoding=,bool hex=',
		'mb_encoding_aliases' => 'string encoding',
		'mb_ereg' => 'string pattern,string string,mixed &matches=',
		'mb_ereg_match' => 'string pattern,string string,string|null options=',
		'mb_ereg_replace' => 'string pattern,string replacement,string string,string|null options=',
		'mb_ereg_replace_callback' => 'string pattern,callable callback,string string,string|null options=',
		'mb_ereg_search' => 'string|null pattern=,string|null options=',
		...
		'mb_eregi' => 'string pattern,string string,mixed &matches=',
		'mb_eregi_replace' => 'string pattern,string replacement,string string,string|null options=',
		...
		'mb_lcfirst' => 'string string,string|null encoding=',
		'mb_list_encodings' => '',
		'mb_ltrim' => 'string string,string|null characters=,string|null encoding=',
		'mb_ord' => 'string string,string|null encoding=',
		'mb_output_handler' => 'string string,int status',
		'mb_parse_str' => 'string string,mixed &result',
		'mb_preferred_mime_name' => 'string encoding',
		'mb_regex_encoding' => 'string|null encoding=',
		'mb_regex_set_options' => 'string|null options=',
		'mb_rtrim' => 'string string,string|null characters=,string|null encoding=',
		...
		'mb_str_pad' => 'string string,int length,string pad_string=,int pad_type=,string|null encoding=',
		'mb_str_split' => 'string string,int length=,string|null encoding=',
		...
		'mb_stripos' => 'string haystack,string needle,int offset=,string|null encoding=',
		'mb_stristr' => 'string haystack,string needle,bool before_needle=,string|null encoding=',
		'mb_strlen' => 'string string,string|null encoding=',
		'mb_strpos' => 'string haystack,string needle,int offset=,string|null encoding=',
		'mb_strrchr' => 'string haystack,string needle,bool before_needle=,string|null encoding=',
		'mb_strrichr' => 'string haystack,string needle,bool before_needle=,string|null encoding=',
		'mb_strripos' => 'string haystack,string needle,int offset=,string|null encoding=',
		'mb_strrpos' => 'string haystack,string needle,int offset=,string|null encoding=',
		'mb_strstr' => 'string haystack,string needle,bool before_needle=,string|null encoding=',
		...
		'mb_trim' => 'string string,string|null characters=,string|null encoding=',
		'mb_ucfirst' => 'string string,string|null encoding=',
		...
		'method_exists' => 'mixed object_or_class,string method',
		...
		'mime_content_type' => 'mixed filename',
		'min' => 'mixed value,mixed ...values=',
		'mkdir' => 'string directory,int permissions=,bool recursive=,mixed context=',
		'mktime' => 'int hour,int|null minute=,int|null second=,int|null month=,int|null day=,int|null year=',
		'move_uploaded_file' => 'string from,string to',
		'msg_get_queue' => 'int key,int permissions=',
		'msg_queue_exists' => 'int key',
		'msg_receive' => 'SysvMessageQueue queue,int desired_message_type,mixed &received_message_type,int max_message_size,mixed &message,bool unserialize=,int flags=,mixed &error_code=',
		'msg_remove_queue' => 'SysvMessageQueue queue',
		'msg_send' => 'SysvMessageQueue queue,int message_type,mixed message,bool serialize=,bool blocking=,mixed &error_code=',
		...
		'mt_srand' => 'int|null seed=,int mode=',
		'mysqli_affected_rows' => 'mysqli mysql',
		'mysqli_autocommit' => 'mysqli mysql,bool enable',
		'mysqli_begin_transaction' => 'mysqli mysql,int flags=,string|null name=',
		...
		'mysqli_commit' => 'mysqli mysql,int flags=,string|null name=',
		'mysqli_connect' => 'string|null hostname=,string|null username=,string|null password=,string|null database=,int|null port=,string|null socket=',
		...
		'mysqli_execute' => 'mysqli_stmt statement,array|null params=',
		'mysqli_execute_query' => 'mysqli mysql,string query,array|null params=',
		'mysqli_fetch_all' => 'mysqli_result result,int mode=',
		'mysqli_fetch_array' => 'mysqli_result result,int mode=',
		'mysqli_fetch_assoc' => 'mysqli_result result',
		'mysqli_fetch_column' => 'mysqli_result result,int column=',
		...
		'mysqli_fetch_object' => 'mysqli_result result,string class=,array constructor_args=',
		...
		'mysqli_get_client_info' => 'mysqli|null mysql=',
		...
		'mysqli_options' => 'mysqli mysql,int option,mixed value',
		'mysqli_ping' => 'mysqli mysql',
		'mysqli_poll' => 'array|null &read,array|null &error,array &reject,int seconds,int microseconds=',
		'mysqli_prepare' => 'mysqli mysql,string query',
		'mysqli_query' => 'mysqli mysql,string query,int result_mode=',
		'mysqli_real_connect' => 'mysqli mysql,string|null hostname=,string|null username=,string|null password=,string|null database=,int|null port=,string|null socket=,int flags=',
		...
		'mysqli_rollback' => 'mysqli mysql,int flags=,string|null name=',
		...
		'mysqli_set_opt' => 'mysqli mysql,int option,mixed value',
		...
		'mysqli_stmt_execute' => 'mysqli_stmt statement,array|null params=',
		...
		'mysqli_store_result' => 'mysqli mysql,int mode=',
		...
		'number_format' => 'float num,int decimals=,string|null decimal_separator=,string|null thousands_separator=',
		'numfmt_create' => 'string locale,int style,string|null pattern=',
		...
		'numfmt_parse' => 'NumberFormatter formatter,string string,int type=,mixed &offset=',
		'numfmt_parse_currency' => 'NumberFormatter formatter,string string,mixed &currency,mixed &offset=',
		...
		'ob_list_handlers' => '',
		'ob_start' => 'mixed callback=,int chunk_size=,int flags=',
		'octdec' => 'string octal_string',
		'odbc_autocommit' => 'Odbc\\Connection odbc,bool|null enable=',
		'odbc_binmode' => 'Odbc\\Result statement,int mode',
		'odbc_close' => 'Odbc\\Connection odbc',
		'odbc_close_all' => '',
		'odbc_columnprivileges' => 'Odbc\\Connection odbc,string|null catalog,string schema,string table,string column',
		'odbc_columns' => 'Odbc\\Connection odbc,string|null catalog=,string|null schema=,string|null table=,string|null column=',
		'odbc_commit' => 'Odbc\\Connection odbc',
		'odbc_connect' => 'string dsn,string|null user=,string|null password=,int cursor_option=',
		...
		'odbc_error' => 'Odbc\\Connection|null odbc=',
		'odbc_errormsg' => 'Odbc\\Connection|null odbc=',
		'odbc_exec' => 'Odbc\\Connection odbc,string query',
		'odbc_execute' => 'Odbc\\Result statement,array params=',
		'odbc_fetch_array' => 'Odbc\\Result statement,int|null row=',
		'odbc_fetch_into' => 'Odbc\\Result statement,mixed &array,int|null row=',
		'odbc_fetch_object' => 'Odbc\\Result statement,int|null row=',
		'odbc_fetch_row' => 'Odbc\\Result statement,int|null row=',
		...
		'odbc_foreignkeys' => 'Odbc\\Connection odbc,string|null pk_catalog,string pk_schema,string pk_table,string fk_catalog,string fk_schema,string fk_table',
		'odbc_free_result' => 'Odbc\\Result statement',
		'odbc_gettypeinfo' => 'Odbc\\Connection odbc,int data_type=',
		...
		'odbc_pconnect' => 'string dsn,string|null user=,string|null password=,int cursor_option=',
		'odbc_prepare' => 'Odbc\\Connection odbc,string query',
		'odbc_primarykeys' => 'Odbc\\Connection odbc,string|null catalog,string schema,string table',
		'odbc_procedurecolumns' => 'Odbc\\Connection odbc,string|null catalog=,string|null schema=,string|null procedure=,string|null column=',
		'odbc_procedures' => 'Odbc\\Connection odbc,string|null catalog=,string|null schema=,string|null procedure=',
		...
		'odbc_specialcolumns' => 'Odbc\\Connection odbc,int type,string|null catalog,string schema,string table,int scope,int nullable',
		'odbc_statistics' => 'Odbc\\Connection odbc,string|null catalog,string schema,string table,int unique,int accuracy',
		'odbc_tableprivileges' => 'Odbc\\Connection odbc,string|null catalog,string schema,string table',
		'odbc_tables' => 'Odbc\\Connection odbc,string|null catalog=,string|null schema=,string|null table=,string|null types=',
		'opcache_compile_file' => 'string filename',
		'opcache_get_configuration' => '',
		'opcache_get_status' => 'bool include_scripts=',
		'opcache_invalidate' => 'string filename,bool force=',
		...
		'opcache_reset' => '',
		'opendir' => 'string directory,mixed context=',
		...
		'openssl_cms_decrypt' => 'string input_filename,string output_filename,mixed certificate,mixed private_key=,int encoding=',
		'openssl_cms_encrypt' => 'string input_filename,string output_filename,mixed certificate,array|null headers,int flags=,int encoding=,string|int cipher_algo=',
		'openssl_cms_read' => 'string input_filename,mixed &certificates',
		'openssl_cms_sign' => 'string input_filename,string output_filename,OpenSSLCertificate|string certificate,mixed private_key,array|null headers,int flags=,int encoding=,string|null untrusted_certificates_filename=',
		'openssl_cms_verify' => 'string input_filename,int flags=,string|null certificates=,array ca_info=,string|null untrusted_certificates_filename=,string|null content=,string|null pk7=,string|null sigfile=,int encoding=',
		'openssl_csr_export' => 'OpenSSLCertificateSigningRequest|string csr,mixed &output,bool no_text=',
		...
		'openssl_csr_new' => 'array distinguished_names,mixed &private_key,array|null options=,array|null extra_attributes=',
		'openssl_csr_sign' => 'OpenSSLCertificateSigningRequest|string csr,OpenSSLCertificate|string|null ca_certificate,mixed private_key,int days,array|null options=,int serial=,string|null serial_hex=',
		'openssl_decrypt' => 'string data,string cipher_algo,string passphrase,int options=,string iv=,string|null tag=,string aad=',
		...
		'openssl_encrypt' => 'string data,string cipher_algo,string passphrase,int options=,string iv=,mixed &tag=,string aad=,int tag_length=',
		...
		'openssl_get_privatekey' => 'mixed private_key,string|null passphrase=',
		'openssl_get_publickey' => 'mixed public_key',
		'openssl_open' => 'string data,mixed &output,string encrypted_key,mixed private_key,string cipher_algo,string|null iv=',
		'openssl_pbkdf2' => 'string password,string salt,int key_length,int iterations,string digest_algo=',
		'openssl_pkcs12_export' => 'OpenSSLCertificate|string certificate,mixed &output,mixed private_key,string passphrase,array options=',
		'openssl_pkcs12_export_to_file' => 'OpenSSLCertificate|string certificate,string output_filename,mixed private_key,string passphrase,array options=',
		'openssl_pkcs12_read' => 'string pkcs12,mixed &certificates,string passphrase',
		'openssl_pkcs7_decrypt' => 'string input_filename,string output_filename,mixed certificate,mixed private_key=',
		'openssl_pkcs7_encrypt' => 'string input_filename,string output_filename,mixed certificate,array|null headers,int flags=,int cipher_algo=',
		'openssl_pkcs7_read' => 'string data,mixed &certificates',
		'openssl_pkcs7_sign' => 'string input_filename,string output_filename,OpenSSLCertificate|string certificate,mixed private_key,array|null headers,int flags=,string|null untrusted_certificates_filename=',
		...
		'openssl_pkey_derive' => 'mixed public_key,mixed private_key,int key_length=',
		'openssl_pkey_export' => 'mixed key,mixed &output,string|null passphrase=,array|null options=',
		'openssl_pkey_export_to_file' => 'mixed key,string output_filename,string|null passphrase=,array|null options=',
		'openssl_pkey_free' => 'OpenSSLAsymmetricKey key',
		'openssl_pkey_get_details' => 'OpenSSLAsymmetricKey key',
		'openssl_pkey_get_private' => 'mixed private_key,string|null passphrase=',
		'openssl_pkey_get_public' => 'mixed public_key',
		'openssl_pkey_new' => 'array|null options=',
		'openssl_private_decrypt' => 'string data,mixed &decrypted_data,mixed private_key,int padding=,string|null digest_algo=',
		'openssl_private_encrypt' => 'string data,mixed &encrypted_data,mixed private_key,int padding=',
		'openssl_public_decrypt' => 'string data,mixed &decrypted_data,mixed public_key,int padding=',
		'openssl_public_encrypt' => 'string data,mixed &encrypted_data,mixed public_key,int padding=,string|null digest_algo=',
		'openssl_random_pseudo_bytes' => 'int length,mixed &strong_result=',
		'openssl_seal' => 'string data,mixed &sealed_data,mixed &encrypted_keys,array public_key,string cipher_algo,mixed &iv=',
		'openssl_sign' => 'string data,mixed &signature,mixed private_key,string|int algorithm=,int padding=',
		...
		'openssl_verify' => 'string data,string signature,mixed public_key,string|int algorithm=,int padding=',
		'openssl_x509_check_private_key' => 'OpenSSLCertificate|string certificate,mixed private_key',
		'openssl_x509_checkpurpose' => 'OpenSSLCertificate|string certificate,int purpose,array ca_info=,string|null untrusted_certificates_file=',
		'openssl_x509_export' => 'OpenSSLCertificate|string certificate,mixed &output,bool no_text=',
		...
		'openssl_x509_verify' => 'OpenSSLCertificate|string certificate,mixed public_key',
		...
		'parse_str' => 'string string,mixed &result',
		'parse_url' => 'string url,int component=',
		'passthru' => 'string command,mixed &result_code=',
		'password_algos' => '',
		...
		'pcntl_async_signals' => 'bool|null enable=',
		'pcntl_errno' => '',
		'pcntl_exec' => 'string path,array args=,array env_vars=',
		'pcntl_fork' => '',
		'pcntl_get_last_error' => '',
		'pcntl_getcpuaffinity' => 'int|null process_id=',
		'pcntl_getpriority' => 'int|null process_id=,int mode=',
		'pcntl_setcpuaffinity' => 'int|null process_id=,array cpu_ids=',
		'pcntl_setpriority' => 'int priority,int|null process_id=,int mode=',
		'pcntl_signal' => 'int signal,mixed handler,bool restart_syscalls=',
		'pcntl_signal_dispatch' => '',
		'pcntl_signal_get_handler' => 'int signal',
		'pcntl_sigprocmask' => 'int mode,array signals,mixed &old_signals=',
		'pcntl_sigtimedwait' => 'array signals,mixed &info=,int seconds=,int nanoseconds=',
		'pcntl_sigwaitinfo' => 'array signals,mixed &info=',
		'pcntl_strerror' => 'int error_code',
		'pcntl_unshare' => 'int flags',
		'pcntl_wait' => 'mixed &status,int flags=,mixed &resource_usage=',
		'pcntl_waitid' => 'int idtype=,int|null id=,mixed &info=,int flags=,mixed &resource_usage=',
		'pcntl_waitpid' => 'int process_id,mixed &status,int flags=,mixed &resource_usage=',
		...
		'pdo_drivers' => '',
		'pfsockopen' => 'string hostname,int port=,mixed &error_code=,mixed &error_message=,float|null timeout=',
		'pg_affected_rows' => 'PgSql\\Result result',
		'pg_cancel_query' => 'PgSql\\Connection connection',
		'pg_change_password' => 'PgSql\\Connection connection,string user,string password',
		'pg_client_encoding' => 'PgSql\\Connection|null connection=',
		'pg_clientencoding' => 'PgSql\\Connection|null connection=',
		'pg_close' => 'PgSql\\Connection|null connection=',
		'pg_close_stmt' => 'Pgsql\\Connection connection,string statement_name',
		...
		'pg_copy_from' => 'PgSql\\Connection connection,string table_name,Traversable|array rows,string separator=,string null_as=',
		'pg_copy_to' => 'PgSql\\Connection connection,string table_name,string separator=,string null_as=',
		'pg_dbname' => 'PgSql\\Connection|null connection=',
		'pg_delete' => 'PgSql\\Connection connection,string table_name,array conditions,int flags=',
		'pg_end_copy' => 'PgSql\\Connection|null connection=',
		'pg_errormessage' => 'PgSql\\Connection|null connection=',
		'pg_escape_bytea' => 'mixed connection,string string=',
		'pg_escape_identifier' => 'mixed connection,string string=',
		'pg_escape_literal' => 'mixed connection,string string=',
		'pg_escape_string' => 'mixed connection,string string=',
		'pg_exec' => 'mixed connection,string query=',
		'pg_execute' => 'mixed connection,mixed statement_name,array params=',
		'pg_fetch_all' => 'PgSql\\Result result,int mode=',
		'pg_fetch_all_columns' => 'PgSql\\Result result,int field=',
		'pg_fetch_array' => 'PgSql\\Result result,int|null row=,int mode=',
		'pg_fetch_assoc' => 'PgSql\\Result result,int|null row=',
		'pg_fetch_object' => 'PgSql\\Result result,int|null row=,string class=,array constructor_args=',
		'pg_fetch_result' => 'PgSql\\Result result,mixed row,string|int field=',
		'pg_fetch_row' => 'PgSql\\Result result,int|null row=,int mode=',
		'pg_field_is_null' => 'PgSql\\Result result,mixed row,string|int field=',
		'pg_field_name' => 'PgSql\\Result result,int field',
		'pg_field_num' => 'PgSql\\Result result,string field',
		'pg_field_prtlen' => 'PgSql\\Result result,mixed row,string|int field=',
		...
		'pg_fieldisnull' => 'PgSql\\Result result,mixed row,string|int field=',
		'pg_fieldname' => 'PgSql\\Result result,int field',
		'pg_fieldnum' => 'PgSql\\Result result,string field',
		'pg_fieldprtlen' => 'PgSql\\Result result,mixed row,string|int field=',
		...
		'pg_host' => 'PgSql\\Connection|null connection=',
		'pg_insert' => 'PgSql\\Connection connection,string table_name,array values,int flags=',
		'pg_jit' => 'PgSql\\Connection|null connection=',
		'pg_last_error' => 'PgSql\\Connection|null connection=',
		'pg_last_notice' => 'PgSql\\Connection connection,int mode=',
		'pg_last_oid' => 'PgSql\\Result result',
		'pg_lo_close' => 'PgSql\\Lob lob',
		'pg_lo_create' => 'mixed connection=,mixed oid=',
		'pg_lo_export' => 'mixed connection,mixed oid=,mixed filename=',
		'pg_lo_import' => 'mixed connection,mixed filename=,mixed oid=',
		'pg_lo_open' => 'mixed connection,mixed oid=,string mode=',
		...
		'pg_lo_unlink' => 'mixed connection,mixed oid=',
		'pg_lo_write' => 'PgSql\\Lob lob,string data,int|null length=',
		'pg_loclose' => 'PgSql\\Lob lob',
		'pg_locreate' => 'mixed connection=,mixed oid=',
		'pg_loexport' => 'mixed connection,mixed oid=,mixed filename=',
		'pg_loimport' => 'mixed connection,mixed filename=,mixed oid=',
		'pg_loopen' => 'mixed connection,mixed oid=,string mode=',
		'pg_loread' => 'PgSql\\Lob lob,int length=',
		'pg_loreadall' => 'PgSql\\Lob lob',
		'pg_lounlink' => 'mixed connection,mixed oid=',
		'pg_lowrite' => 'PgSql\\Lob lob,string data,int|null length=',
		...
		'pg_options' => 'PgSql\\Connection|null connection=',
		'pg_parameter_status' => 'mixed connection,string name=',
		'pg_pconnect' => 'string connection_string,int flags=',
		'pg_ping' => 'PgSql\\Connection|null connection=',
		'pg_port' => 'PgSql\\Connection|null connection=',
		'pg_prepare' => 'mixed connection,string statement_name,string query=',
		'pg_put_copy_data' => 'PgSql\\Connection connection,string cmd',
		'pg_put_copy_end' => 'PgSql\\Connection connection,string|null error=',
		'pg_put_line' => 'mixed connection,string query=',
		'pg_query' => 'mixed connection,string query=',
		'pg_query_params' => 'mixed connection,mixed query,array params=',
		'pg_result' => 'PgSql\\Result result,mixed row,string|int field=',
		...
		'pg_set_client_encoding' => 'mixed connection,string encoding=',
		'pg_set_error_context_visibility' => 'PgSql\\Connection connection,int visibility',
		'pg_set_error_verbosity' => 'mixed connection,int verbosity=',
		'pg_setclientencoding' => 'mixed connection,string encoding=',
		'pg_socket' => 'PgSql\\Connection connection',
		'pg_socket_poll' => 'mixed socket,int read,int write,int timeout=',
		'pg_trace' => 'string filename,string mode=,PgSql\\Connection|null connection=,int trace_mode=',
		'pg_transaction_status' => 'PgSql\\Connection connection',
		'pg_tty' => 'PgSql\\Connection|null connection=',
		'pg_unescape_bytea' => 'string string',
		'pg_untrace' => 'PgSql\\Connection|null connection=',
		'pg_update' => 'PgSql\\Connection connection,string table_name,array values,array conditions,int flags=',
		'pg_version' => 'PgSql\\Connection|null connection=',
		'php_ini_loaded_file' => '',
		...
		'posix_getrlimit' => 'int|null resource=',
		...
		'posix_times' => '',
		'posix_ttyname' => 'mixed file_descriptor',
		'posix_uname' => '',
		'pow' => 'mixed num,mixed exponent',
		'preg_filter' => 'array|string pattern,array|string replacement,array|string subject,int limit=,mixed &count=',
		'preg_grep' => 'string pattern,array array,int flags=',
		'preg_last_error' => '',
		'preg_last_error_msg' => '',
		'preg_match' => 'string pattern,string subject,mixed &matches=,int flags=,int offset=',
		'preg_match_all' => 'string pattern,string subject,mixed &matches=,int flags=,int offset=',
		'preg_quote' => 'string str,string|null delimiter=',
		'preg_replace' => 'array|string pattern,array|string replacement,array|string subject,int limit=,mixed &count=',
		'preg_replace_callback' => 'array|string pattern,callable callback,array|string subject,int limit=,mixed &count=,int flags=',
		'preg_replace_callback_array' => 'array pattern,array|string subject,int limit=,mixed &count=,int flags=',
		'preg_split' => 'string pattern,string subject,int limit=,int flags=',
		'prev' => 'object|array &array',
		'print_r' => 'mixed value,bool return=',
		'printf' => 'string format,mixed ...values=',
		'proc_close' => 'mixed process',
		'proc_get_status' => 'mixed process',
		'proc_nice' => 'int priority',
		'proc_open' => 'array|string command,array descriptor_spec,mixed &pipes,string|null cwd=,array|null env_vars=,array|null options=',
		'proc_terminate' => 'mixed process,int signal=',
		'property_exists' => 'mixed object_or_class,string property',
		'pspell_add_to_personal' => 'PSpell\\Dictionary dictionary,string word',
		'pspell_add_to_session' => 'PSpell\\Dictionary dictionary,string word',
		'pspell_check' => 'PSpell\\Dictionary dictionary,string word',
		'pspell_clear_session' => 'PSpell\\Dictionary dictionary',
		'pspell_config_create' => 'string language,string spelling=,string jargon=,string encoding=',
		'pspell_config_data_dir' => 'PSpell\\Config config,string directory',
		'pspell_config_dict_dir' => 'PSpell\\Config config,string directory',
		'pspell_config_ignore' => 'PSpell\\Config config,int min_length',
		'pspell_config_mode' => 'PSpell\\Config config,int mode',
		'pspell_config_personal' => 'PSpell\\Config config,string filename',
		'pspell_config_repl' => 'PSpell\\Config config,string filename',
		'pspell_config_runtogether' => 'PSpell\\Config config,bool allow',
		'pspell_config_save_repl' => 'PSpell\\Config config,bool save',
		...
		'pspell_save_wordlist' => 'PSpell\\Dictionary dictionary',
		'pspell_store_replacement' => 'PSpell\\Dictionary dictionary,string misspelled,string correct',
		...
		'readdir' => 'mixed dir_handle=',
		'readfile' => 'string filename,bool use_include_path=,mixed context=',
		...
		'readline_info' => 'string|null var_name=,mixed value=',
		...
		'rename' => 'string from,string to,mixed context=',
		'request_parse_body' => 'array|null options=',
		'reset' => 'object|array &array',
		'resourcebundle_count' => 'ResourceBundle bundle',
		'resourcebundle_create' => 'string|null locale,string|null bundle,bool fallback=',
		'resourcebundle_get' => 'ResourceBundle bundle,string|int index,bool fallback=',
		...
		'rewind' => 'mixed stream',
		'rewinddir' => 'mixed dir_handle=',
		'rmdir' => 'string directory,mixed context=',
		'round' => 'int|float num,int precision=,RoundingMode|int mode=',
		'rsort' => 'array &array,int flags=',
		'rtrim' => 'string string,string characters=',
		'scandir' => 'string directory,int sorting_order=,mixed context=',
		'sem_acquire' => 'SysvSemaphore semaphore,bool non_blocking=',
		...
		'session_set_cookie_params' => 'array|int lifetime_or_options,string|null path=,string|null domain=,bool|null secure=,bool|null httponly=',
		'session_set_save_handler' => 'mixed open,mixed close=,callable read=,callable write=,callable destroy=,callable gc=,callable|null create_sid=,callable|null validate_sid=,callable|null update_timestamp=',
		'session_start' => 'array options=',
		'session_status' => '',
		'session_unset' => '',
		'session_write_close' => '',
		'set_error_handler' => 'callable|null callback,int error_levels=',
		'set_exception_handler' => 'callable|null callback',
		'set_file_buffer' => 'mixed stream,int size',
		...
		'setlocale' => 'int category,mixed locales,mixed ...rest=',
		...
		'shm_attach' => 'int key,int|null size=,int permissions=',
		...
		'shuffle' => 'array &array',
		'similar_text' => 'string string1,string string2,mixed &percent=',
		'simplexml_import_dom' => 'object node,string|null class_name=',
		'simplexml_load_file' => 'string filename,string|null class_name=,int options=,string namespace_or_prefix=,bool is_prefix=',
		'simplexml_load_string' => 'string data,string|null class_name=,int options=,string namespace_or_prefix=,bool is_prefix=',
		'sin' => 'float num',
		'sinh' => 'float num',
		...
		'socket_clear_error' => 'Socket|null socket=',
		'socket_close' => 'Socket socket',
		'socket_cmsg_space' => 'int level,int type,int num=',
		'socket_connect' => 'Socket socket,string address,int|null port=',
		'socket_create' => 'int domain,int type,int protocol',
		'socket_create_listen' => 'int port,int backlog=',
		'socket_create_pair' => 'int domain,int type,int protocol,mixed &pair',
		'socket_export_stream' => 'Socket socket',
		'socket_get_option' => 'Socket socket,int level,int option',
		'socket_get_status' => 'mixed stream',
		'socket_getopt' => 'Socket socket,int level,int option',
		'socket_getpeername' => 'Socket socket,mixed &address,mixed &port=',
		'socket_getsockname' => 'Socket socket,mixed &address,mixed &port=',
		'socket_import_stream' => 'mixed stream',
		'socket_last_error' => 'Socket|null socket=',
		'socket_listen' => 'Socket socket,int backlog=',
		'socket_read' => 'Socket socket,int length,int mode=',
		'socket_recv' => 'Socket socket,mixed &data,int length,int flags',
		'socket_recvfrom' => 'Socket socket,mixed &data,int length,int flags,mixed &address,mixed &port=',
		'socket_recvmsg' => 'Socket socket,array &message,int flags=',
		'socket_select' => 'array|null &read,array|null &write,array|null &except,int|null seconds,int microseconds=',
		'socket_send' => 'Socket socket,string data,int length,int flags',
		'socket_sendmsg' => 'Socket socket,array message,int flags=',
		'socket_sendto' => 'Socket socket,string data,int length,int flags,string address,int|null port=',
		'socket_set_block' => 'Socket socket',
		'socket_set_blocking' => 'mixed stream,bool enable',
		'socket_set_nonblock' => 'Socket socket',
		'socket_set_option' => 'Socket socket,int level,int option,mixed value',
		'socket_set_timeout' => 'mixed stream,int seconds,int microseconds=',
		'socket_setopt' => 'Socket socket,int level,int option,mixed value',
		'socket_shutdown' => 'Socket socket,int mode=',
		'socket_strerror' => 'int error_code',
		'socket_write' => 'Socket socket,string data,int|null length=',
		...
		'spl_autoload_register' => 'callable|null callback=,bool throw=,bool prepend=',
		...
		'str_ireplace' => 'array|string search,array|string replace,array|string subject,mixed &count=',
		'str_pad' => 'string string,int length,string pad_string=,int pad_type=',
		'str_repeat' => 'string string,int times',
		'str_replace' => 'array|string search,array|string replace,array|string subject,mixed &count=',
		...
		'str_word_count' => 'string string,int format=,string|null characters=',
		...
		'strcspn' => 'string string,string characters,int offset=,int|null length=',
		'stream_bucket_append' => 'mixed brigade,StreamBucket bucket',
		'stream_bucket_make_writeable' => 'mixed brigade',
		'stream_bucket_new' => 'mixed stream,string buffer',
		'stream_bucket_prepend' => 'mixed brigade,StreamBucket bucket',
		'stream_context_create' => 'array|null options=,array|null params=',
		'stream_context_get_default' => 'array|null options=',
		'stream_context_get_options' => 'mixed stream_or_context',
		'stream_context_get_params' => 'mixed context',
		'stream_context_set_default' => 'array options',
		'stream_context_set_option' => 'mixed context,array|string wrapper_or_options,string|null option_name=,mixed value=',
		'stream_context_set_options' => 'mixed context,array options',
		'stream_context_set_params' => 'mixed context,array params',
		'stream_copy_to_stream' => 'mixed from,mixed to,int|null length=,int offset=',
		'stream_filter_append' => 'mixed stream,string filter_name,int mode=,mixed params=',
		'stream_filter_prepend' => 'mixed stream,string filter_name,int mode=,mixed params=',
		'stream_filter_register' => 'string filter_name,string class',
		'stream_filter_remove' => 'mixed stream_filter',
		'stream_get_contents' => 'mixed stream,int|null length=,int offset=',
		'stream_get_filters' => '',
		'stream_get_line' => 'mixed stream,int length,string ending=',
		'stream_get_meta_data' => 'mixed stream',
		'stream_get_transports' => '',
		'stream_get_wrappers' => '',
		'stream_is_local' => 'mixed stream',
		'stream_isatty' => 'mixed stream',
		'stream_register_wrapper' => 'string protocol,string class,int flags=',
		'stream_resolve_include_path' => 'string filename',
		'stream_select' => 'array|null &read,array|null &write,array|null &except,int|null seconds,int|null microseconds=',
		'stream_set_blocking' => 'mixed stream,bool enable',
		'stream_set_chunk_size' => 'mixed stream,int size',
		'stream_set_read_buffer' => 'mixed stream,int size',
		'stream_set_timeout' => 'mixed stream,int seconds,int microseconds=',
		'stream_set_write_buffer' => 'mixed stream,int size',
		'stream_socket_accept' => 'mixed socket,float|null timeout=,mixed &peer_name=',
		'stream_socket_client' => 'string address,mixed &error_code=,mixed &error_message=,float|null timeout=,int flags=,mixed context=',
		'stream_socket_enable_crypto' => 'mixed stream,bool enable,int|null crypto_method=,mixed session_stream=',
		'stream_socket_get_name' => 'mixed socket,bool remote',
		'stream_socket_pair' => 'int domain,int type,int protocol',
		'stream_socket_recvfrom' => 'mixed socket,int length,int flags=,mixed &address=',
		'stream_socket_sendto' => 'mixed socket,string data,int flags=,string address=',
		'stream_socket_server' => 'string address,mixed &error_code=,mixed &error_message=,int flags=,mixed context=',
		'stream_socket_shutdown' => 'mixed stream,int mode',
		'stream_supports_lock' => 'mixed stream',
		...
		'strspn' => 'string string,string characters,int offset=,int|null length=',
		'strstr' => 'string haystack,string needle,bool before_needle=',
		'strtok' => 'string string,string|null token=',
		'strtolower' => 'string string',
		'strtotime' => 'string datetime,int|null baseTimestamp=',
		'strtoupper' => 'string string',
		'strtr' => 'string string,array|string from,string|null to=',
		'strval' => 'mixed value',
		'substr' => 'string string,int offset,int|null length=',
		'substr_compare' => 'string haystack,string needle,int offset,int|null length=,bool case_insensitive=',
		'substr_count' => 'string haystack,string needle,int offset=,int|null length=',
		...
		'system' => 'string command,mixed &result_code=',
		'tan' => 'float num',
		'tanh' => 'float num',
		'tempnam' => 'string directory,string prefix',
		'textdomain' => 'string|null domain=',
		...
		'tidy_parse_file' => 'string filename,array|string|null config=,string|null encoding=,bool useIncludePath=',
		'tidy_parse_string' => 'string string,array|string|null config=,string|null encoding=',
		'tidy_repair_file' => 'string filename,array|string|null config=,string|null encoding=,bool useIncludePath=',
		'tidy_repair_string' => 'string string,array|string|null config=,string|null encoding=',
		'tidy_warning_count' => 'tidy tidy',
		'time' => '',
		'time_nanosleep' => 'int seconds,int nanoseconds',
		'time_sleep_until' => 'float timestamp',
		'timezone_abbreviations_list' => '',
		'timezone_identifiers_list' => 'int timezoneGroup=,string|null countryCode=',
		...
		'unixtojd' => 'int|null timestamp=',
		'unlink' => 'string filename,mixed context=',
		...
		'vfprintf' => 'mixed stream,string format,array values',
		...
		'xml_parse_into_struct' => 'XMLParser parser,string data,mixed &values,mixed &index=',
		...
		'xml_parser_set_option' => 'XMLParser parser,int option,mixed value',
		...
		'xmlwriter_start_attribute_ns' => 'XMLWriter writer,string|null prefix,string name,string|null namespace',
		'xmlwriter_start_cdata' => 'XMLWriter writer',
		'xmlwriter_start_comment' => 'XMLWriter writer',
		'xmlwriter_start_document' => 'XMLWriter writer,string|null version=,string|null encoding=,string|null standalone=',
		'xmlwriter_start_dtd' => 'XMLWriter writer,string qualifiedName,string|null publicId=,string|null systemId=',
		...
		'xmlwriter_start_element_ns' => 'XMLWriter writer,string|null prefix,string name,string|null namespace',
		...
		'xmlwriter_write_attribute_ns' => 'XMLWriter writer,string|null prefix,string name,string|null namespace,string value',
		'xmlwriter_write_cdata' => 'XMLWriter writer,string content',
		'xmlwriter_write_comment' => 'XMLWriter writer,string content',
		'xmlwriter_write_dtd' => 'XMLWriter writer,string name,string|null publicId=,string|null systemId=,string|null content=',
		...
		'xmlwriter_write_dtd_entity' => 'XMLWriter writer,string name,string content,bool isParam=,string|null publicId=,string|null systemId=,string|null notationData=',
		'xmlwriter_write_element' => 'XMLWriter writer,string name,string|null content=',
		'xmlwriter_write_element_ns' => 'XMLWriter writer,string|null prefix,string name,string|null namespace,string|null content=',
		'xmlwriter_write_pi' => 'XMLWriter writer,string target,string content',
		'xmlwriter_write_raw' => 'XMLWriter writer,string content',
		'zend_version' => '',
		'zip_close' => 'mixed zip',
		'zip_entry_close' => 'mixed zip_entry',
		'zip_entry_compressedsize' => 'mixed zip_entry',
		'zip_entry_compressionmethod' => 'mixed zip_entry',
		'zip_entry_filesize' => 'mixed zip_entry',
		'zip_entry_name' => 'mixed zip_entry',
		'zip_entry_open' => 'mixed zip_dp,mixed zip_entry,string mode=',
		'zip_entry_read' => 'mixed zip_entry,int len=',
