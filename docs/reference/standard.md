...
- Composed of: `dresscode/psr12`, `dresscode/per`, `dresscode/nette-style`, `dresscode/cleanup`, `dresscode/modern`, `dresscode/types`, `dresscode/phpdoc`, `dresscode/imports`, `dresscode/classes`, `dresscode/nette`
- Indentation: a tab
...
As this project has it: `chain`: `nesting`.
