...
Generated by `composer reference` from the rule classes; do not edit. 156 rules.
...
**Indentation** (1): [heredoc-indentation](#dresscodeheredoc-indentation)
