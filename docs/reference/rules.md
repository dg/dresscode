...
**Classes** (34): [class-constant-fetch-for-constant-call](#dresscodeclass-constant-fetch-for-constant-call), [class-definition-spacing](#dresscodeclass-definition-spacing), [class-name-reference-for-string-literal](#dresscodeclass-name-reference-for-string-literal), [final-internal-class](#dresscodefinal-internal-class), [forbidden-classes](#dresscodeforbidden-classes), [forbidden-members](#dresscodeforbidden-members), [kind-in-class-name](#dresscodekind-in-class-name), [modern-class-name-reference](#dresscodemodern-class-name-reference), [name-casing](#dresscodename-casing), [named-arguments-for-flags](#dresscodenamed-arguments-for-flags), [no-deprecated-classes](#dresscodeno-deprecated-classes), [no-deprecated-members](#dresscodeno-deprecated-members), [no-null-debug-info-return](#dresscodeno-null-debug-info-return), [no-sleep-and-wakeup](#dresscodeno-sleep-and-wakeup), [no-this-in-static-context](#dresscodeno-this-in-static-context), [ordered-members](#dresscodeordered-members), [override-attribute-required](#dresscodeoverride-attribute-required), [promoted-property-for-assigned-parameter](#dresscodepromoted-property-for-assigned-parameter), [readonly-class-for-readonly-members](#dresscodereadonly-class-for-readonly-members), [readonly-for-annotation](#dresscodereadonly-for-annotation), [readonly-for-unwritten-property](#dresscodereadonly-for-unwritten-property), [replaced-calls](#dresscodereplaced-calls), [replaced-classes](#dresscodereplaced-classes), [replaced-members](#dresscodereplaced-members), [self-for-current-class](#dresscodeself-for-current-class), [single-member-per-declaration](#dresscodesingle-member-per-declaration), [single-member-per-line](#dresscodesingle-member-per-line), [static-for-private-method-without-this](#dresscodestatic-for-private-method-without-this), [static-set-state-required](#dresscodestatic-set-state-required), [stringable-required](#dresscodestringable-required), [useless-modifier](#dresscodeuseless-modifier), [useless-null-property-initialization](#dresscodeuseless-null-property-initialization), [useless-overriding-method](#dresscodeuseless-overriding-method), [visibility-required](#dresscodevisibility-required)
...
**Functions** (35): [array-first-for-edge-element](#dresscodearray-first-for-edge-element), [arrow-function](#dresscodearrow-function), [clamp-for-min-max](#dresscodeclamp-for-min-max), [csv-escape-argument-required](#dresscodecsv-escape-argument-required), [first-class-callable-notation](#dresscodefirst-class-callable-notation), [forbidden-functions](#dresscodeforbidden-functions), [function-name-spacing](#dresscodefunction-name-spacing), [get-debug-type-for-type-ternary](#dresscodeget-debug-type-for-type-ternary), [json-validate-for-decode-test](#dresscodejson-validate-for-decode-test), [mb-convert-encoding-for-utf8-function](#dresscodemb-convert-encoding-for-utf8-function), [multi-line-call](#dresscodemulti-line-call), [multi-line-signature](#dresscodemulti-line-signature), [named-argument-spacing](#dresscodenamed-argument-spacing), [native-function-casing](#dresscodenative-function-casing), [no-alias-functions](#dresscodeno-alias-functions), [no-call-user-func](#dresscodeno-call-user-func), [no-conversion-functions](#dresscodeno-conversion-functions), [no-deprecated-arguments](#dresscodeno-deprecated-arguments), [no-deprecated-functions](#dresscodeno-deprecated-functions), [no-direct-invoke-call](#dresscodeno-direct-invoke-call), [no-dirname-of-file](#dresscodeno-dirname-of-file), [no-inner-functions](#dresscodeno-inner-functions), [no-is-null](#dresscodeno-is-null), [no-manual-empty-string-test](#dresscodeno-manual-empty-string-test), [no-manual-substring-test](#dresscodeno-manual-substring-test), [no-settype](#dresscodeno-settype), [optimized-call-notation](#dresscodeoptimized-call-notation), [replaced-functions](#dresscodereplaced-functions), [rounding-mode-notation](#dresscoderounding-mode-notation), [sensitive-parameter-required](#dresscodesensitive-parameter-required), [static-closure](#dresscodestatic-closure), [strict-call](#dresscodestrict-call), [useless-no-op-call](#dresscodeuseless-no-op-call), [useless-parameter-default](#dresscodeuseless-parameter-default), [useless-set-accessible](#dresscodeuseless-set-accessible)
...
Options: The annotation, without the @ → the attribute written instead, its class fully qualified, with its arguments where it has any.
...
Options: The forbidden member, `Class::name` (a constant or a method), `Class::name(...$args)` (a method), `Class::$name` (a property), `Class::__construct(...$args)`, or a call with the shape of its arguments, `Class::name()` being one without any → what to do instead, as the end of the message.
...
Passes the named arguments a method takes instead of the flags of an integer.

Stage: Structure. Needs the types of the code, so it runs only with `types: phpstan`.

Options: The call, `Class::name($value, $flags)` with the placeholder of the flags last → the flag, `Class::NAME` or `NAME` → the named arguments it becomes, `{pretty: true}`.
...
Options: The replaced use, `Class::name($a, true)`, `Class::name(...$args)` with any arguments, `Class::name()` without any, `Class::__construct($a)` or a magic method for the syntax PHP calls it by → the expression written instead, with the placeholders of the key; `Class::$name` → `{get: expression, set: expression with $value}`.
