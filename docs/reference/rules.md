...
Generated by `composer reference` from the rule classes; do not edit. 161 rules.
...
**Position** (3): [attribute-position](#dresscodeattribute-position), [braces-position](#dresscodebraces-position), [continuation-position](#dresscodecontinuation-position)
