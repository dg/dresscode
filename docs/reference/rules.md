...
Generated by `composer reference` from the rule classes; do not edit. 162 rules.
...
**Classes** (13): [class-definition-spacing](#dresscodeclass-definition-spacing), [final-internal-class](#dresscodefinal-internal-class), [modern-class-name-reference](#dresscodemodern-class-name-reference), [name-casing](#dresscodename-casing), [no-kind-in-class-name](#dresscodeno-kind-in-class-name), [no-this-in-static-context](#dresscodeno-this-in-static-context), [ordered-members](#dresscodeordered-members), [self-for-current-class](#dresscodeself-for-current-class), [single-member-per-declaration](#dresscodesingle-member-per-declaration), [single-member-per-line](#dresscodesingle-member-per-line), [useless-modifier](#dresscodeuseless-modifier), [useless-null-property-initialization](#dresscodeuseless-null-property-initialization), [visibility-required](#dresscodevisibility-required)
...
**Whitespace** (12): [attribute-position](#dresscodeattribute-position), [attribute-spacing](#dresscodeattribute-spacing), [body-blank-lines](#dresscodebody-blank-lines), [braces-position](#dresscodebraces-position), [comma-spacing](#dresscodecomma-spacing), [construct-spacing](#dresscodeconstruct-spacing), [declaration-blank-lines](#dresscodedeclaration-blank-lines), [indentation](#dresscodeindentation), [parentheses-spacing](#dresscodeparentheses-spacing), [semicolon-spacing](#dresscodesemicolon-spacing), [single-level-indentation](#dresscodesingle-level-indentation), [statement-blank-lines](#dresscodestatement-blank-lines)
...
**Shape** (6): [ordered-imports](#dresscodeordered-imports), [ordered-members](#dresscodeordered-members), [single-member-per-declaration](#dresscodesingle-member-per-declaration), [single-member-per-line](#dresscodesingle-member-per-line), [single-quoted-strings](#dresscodesingle-quoted-strings), [single-statement-per-line](#dresscodesingle-statement-per-line)
...
Stage: Formatting. Covers: `Squiz.WhiteSpace.ControlStructureSpacing`, `Squiz.WhiteSpace.FunctionOpeningBraceSpace`.
...
Stage: Formatting. Covers: `braces_position`, `PSR2.Classes.ClassDeclaration`, `Squiz.Functions.MultiLineFunctionDeclaration`.
...
| Option | Type | Default | |
|---|---|---|---|
| `position` | `sameLine` \| `nextLine` | `"sameLine"` | On the line of the closing brace before the keyword, or on the line after it |
