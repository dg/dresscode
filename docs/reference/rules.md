...
**correctness** (13): [no-continue-in-switch](#dresscodeno-continue-in-switch), [no-duplicate-assignment](#dresscodeno-duplicate-assignment), [no-duplicate-return-annotation](#dresscodeno-duplicate-return-annotation), [no-empty-var-annotation](#dresscodeno-empty-var-annotation), [no-invisible-characters](#dresscodeno-invisible-characters), [no-null-debug-info-return](#dresscodeno-null-debug-info-return), [no-this-in-static-context](#dresscodeno-this-in-static-context), [no-trailing-whitespace-in-string](#dresscodeno-trailing-whitespace-in-string), [no-unknown-param-annotation](#dresscodeno-unknown-param-annotation), [no-unreachable-catch](#dresscodeno-unreachable-catch), [reference-throwable-only](#dresscodereference-throwable-only), [static-set-state-required](#dresscodestatic-set-state-required), [strict-call](#dresscodestrict-call)
