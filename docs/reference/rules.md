...
Generated by `composer reference` from the rule classes; do not edit. 193 rules.
...
**Classes** (24): [class-constant-fetch-for-constant-call](#dresscodeclass-constant-fetch-for-constant-call), [class-definition-spacing](#dresscodeclass-definition-spacing), [final-internal-class](#dresscodefinal-internal-class), [kind-in-class-name](#dresscodekind-in-class-name), [modern-class-name-reference](#dresscodemodern-class-name-reference), [name-casing](#dresscodename-casing), [no-null-debug-info-return](#dresscodeno-null-debug-info-return), [no-sleep-and-wakeup](#dresscodeno-sleep-and-wakeup), [no-this-in-static-context](#dresscodeno-this-in-static-context), [ordered-members](#dresscodeordered-members), [promoted-property-for-assigned-parameter](#dresscodepromoted-property-for-assigned-parameter), [readonly-class-for-readonly-members](#dresscodereadonly-class-for-readonly-members), [readonly-for-annotation](#dresscodereadonly-for-annotation), [readonly-for-unwritten-property](#dresscodereadonly-for-unwritten-property), [replaced-classes](#dresscodereplaced-classes), [self-for-current-class](#dresscodeself-for-current-class), [single-member-per-declaration](#dresscodesingle-member-per-declaration), [single-member-per-line](#dresscodesingle-member-per-line), [static-for-private-method-without-this](#dresscodestatic-for-private-method-without-this), [static-set-state-required](#dresscodestatic-set-state-required), [stringable-required](#dresscodestringable-required), [useless-modifier](#dresscodeuseless-modifier), [useless-null-property-initialization](#dresscodeuseless-null-property-initialization), [visibility-required](#dresscodevisibility-required)
